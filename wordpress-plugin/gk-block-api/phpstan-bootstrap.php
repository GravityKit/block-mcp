...
defined( 'GK_BLOCK_API_VERSION' ) || define( 'GK_BLOCK_API_VERSION', '2.0.0' );
defined( 'GK_BLOCK_API_PLUGIN_DIR' ) || define( 'GK_BLOCK_API_PLUGIN_DIR', __DIR__ . '/' );
defined( 'GK_BLOCK_API_PLUGIN_URL' ) || define( 'GK_BLOCK_API_PLUGIN_URL', '' );
