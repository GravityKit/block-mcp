...
class AbilitiesRegistryTest extends RestControllerTestCase {
	 ...
	 * tools.manifest.json and return the full, current 28-tool set, matching
	...
	public function test_manifest_lists_all_block_mcp_tools() {
		...
		$this->assertCount( 28, $manifest['tools'] );
	 ...
	 * the manifest itself (still 28 — test_manifest_lists_all_block_mcp_tools).
	 ...
	 * ARE registered as abilities (and the manifest's full 28 count is
