...
class AbilitiesRegistryTest extends RestControllerTestCase {
	 ...
	 * tools.manifest.json and return the full, current 30-tool set, matching
	...
	public function test_manifest_lists_all_block_mcp_tools() {
		...
		$this->assertCount( 30, $manifest['tools'] );
	 ...
	 * the manifest itself (still 30 — test_manifest_lists_all_block_mcp_tools).
	 ...
	 * ARE registered as abilities (and the manifest's full 30 count is
