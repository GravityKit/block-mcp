	...
	public function check_mutation( string $block_name, array $changed_attrs, bool $has_new_html ): array {
		...
		return array(
			array(
				...
				'message'       => sprintf(
					/* translators: 1: changed attribute names, 2: block name */                    __( 'Changing render-affecting attributes (%1$s) on static block "%2$s" without updating innerHTML may leave markup inconsistent. Consider also providing innerHTML or using replace-block.', 'gk-block-mcp' ),
